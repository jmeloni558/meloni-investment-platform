...
(()=>{
  ...
  const advanced=['buydown'];
  const retired=new Set(['cashflow','debt','taxes','amort','support','cloud']);
  ...
  function ensureStyles(){
    ...
    st.textContent=`
      ...
      .tab[data-tab="cashflow"],.tab[data-tab="debt"],.tab[data-tab="taxes"],.tab[data-tab="amort"],.tab[data-tab="support"],.tab[data-tab="cloud"],.tab[data-tab="scenarios"],[data-app-advanced="cashflow"],[data-app-advanced="debt"],[data-app-advanced="taxes"],[data-app-advanced="amort"],[data-app-advanced="support"],[data-app-advanced="cloud"],[data-app-advanced="scenarios"],[data-s8-advanced="cashflow"],[data-s8-advanced="debt"],[data-s8-advanced="taxes"],[data-s8-advanced="amort"],[data-s8-advanced="support"],[data-s8-advanced="cloud"],[data-s8-advanced="scenarios"]{display:none!important}
      #cashflow,#debt,#taxes,#amort,#support,#cloud{display:none!important}
    ...
    if(!shell){
      ...
      shell.innerHTML=`
        ...
        <div class="app-nav-advanced" id="appNavAdvancedPanel" hidden>
          <button data-app-advanced="buydown">Rate Buydown</button>
        </div>`;
      ...
      shell.querySelectorAll('[data-app-advanced]').forEach(btn=>{if(retired.has(btn.dataset.appAdvanced)||contextualOnly.has(btn.dataset.appAdvanced))btn.remove();});
    }
    return true;
  }
