...
(()=>{
  ...
  const advanced=['buydown','scenarios'];
  ...
  function ensureStyles(){
    ...
    st.textContent=`
      ...
      .tab[data-tab="cashflow"],.tab[data-tab="debt"],.tab[data-tab="taxes"],.tab[data-tab="amort"],.tab[data-tab="support"],.tab[data-tab="cloud"],[data-app-advanced="cashflow"],[data-app-advanced="debt"],[data-app-advanced="taxes"],[data-app-advanced="amort"],[data-app-advanced="support"],[data-app-advanced="cloud"],[data-s8-advanced="cashflow"],[data-s8-advanced="debt"],[data-s8-advanced="taxes"],[data-s8-advanced="amort"],[data-s8-advanced="support"],[data-s8-advanced="cloud"]{display:none!important}
    ...
    if(!shell){
      ...
      shell.innerHTML=`
        ...
        <div class="app-nav-advanced" id="appNavAdvancedPanel" hidden>
          <button data-app-advanced="buydown">Rate Buydown</button><button data-app-advanced="scenarios">Scenario Lab</button>
        </div>`;
