...
(() => {
  ...
  function brandRows(title) {
    ...
    return `<tr class="brand"><td colspan="80"><b>${esc(b.company)}</b></td></tr>${logo}<tr class="title"><td colspan="80"><b>${esc(title)}</b></td></tr><tr><td colspan="80">${esc(b.address)}</td></tr><tr><td colspan="80">Prepared by: ${esc(b.person)}</td></tr>${b.contact ? `<tr><td colspan="80">Contact: ${esc(b.contact)}</td></tr>` : ''}<tr><td colspan="80">PropertyThesis • Know the Numbers. Build the Case.</td></tr><tr><td colspan="80"></td></tr>`;
  }
