...
(()=>{
  ...
  function upgrade(){
    ...
    const actions=document.createElement('div');actions.className='pt-sample-live-actions';actions.style.display='flex';actions.style.gap='8px';actions.style.flexWrap='wrap';actions.innerHTML='<a class="pt-sample-btn" data-pt-analysis href="sample-analysis-viewer.html?v=2">Start Free Analysis</a><button type="button" class="pt-sample-btn" data-pt-proforma>Download Sample Pro Forma</button>';first.appendChild(actions);
