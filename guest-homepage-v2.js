...
(()=>{
  ...
  function ensureExperience(sampleSection){
    ...
    experience=document.createElement('div');experience.id='ptHomeExperience';experience.innerHTML=`
      <section class="pt-home-section pt-home-starter pt-home-starter-hero"><div class="pt-home-starter-copy"><div class="pt-home-eyebrow">START WITH A PROPERTY</div><h1>See what the deal supports before you make the case.</h1><p>Enter the property, acquisition price and expected rent. PropertyThesis turns them into a guided investment analysis covering income, expenses, financing, cash flow, value, returns, risk and offer strategy.</p><div class="pt-home-outcome-list" aria-label="Analysis outcomes"><span>Cash flow</span><span>Cap rate</span><span>IRR &amp; NPV</span><span>Value support</span><span>Offer guidance</span></div></div><form class="pt-home-starter-form" id="ptHomeStarterForm"><div class="pt-home-form-intro"><strong>Analyze a property</strong><span>Start free. No credit card.</span></div><label class="pt-home-address-field">Property address <em>Optional</em><input name="address" data-pt-home-address autocomplete="off" placeholder="Enter a property address"></label><div class="pt-home-starter-numbers"><label>Acquisition price <em>Required</em><input name="price" inputmode="decimal" required placeholder="$ Purchase price"></label><label>Expected monthly rent <em>Required</em><input name="rent" inputmode="decimal" required placeholder="$ Monthly rent"></label></div><button type="submit">Analyze This Property Free <span>→</span></button><p class="pt-home-form-note">Build and review every assumption first. Create an account only when you calculate and save the results.</p></form></section>
