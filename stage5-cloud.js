...
function loadStage9Once(){
  ...
  window.__stage9Loading=true;const s=document.createElement('script');s.id='stage9Script';s.src='stage9.js?v=3';s.onload=()=>{window.__stage9Loading=false};s.onerror=()=>{window.__stage9Loading=false};document.body.appendChild(s);
}
