'use strict';
(()=>{
  const VERSION=7,IMPORT_KEY='ptPendingListingImportV1';
  ...
  function organizePropertyFilters(host){
    const groups=[
      ...
      ['Investment screening','Screen unit economics reported with the listing.',['maxPricePerUnit']],
    ];
  ...
  function ensurePanel(){
    ...
    propertyFilters.insertAdjacentHTML('beforeend','<div class="pt-listings-field"><label>Maximum price per unit</label><input name="maxPricePerUnit" inputmode="numeric"></div>');
  ...
  function query(){
    ...
    const optional=['minPrice','maxPrice','bedroomsMin','bedroomsMax','bathroomsMin','bathroomsMax','squareFootageMin','squareFootageMax','lotSizeMin','lotSizeMax','yearBuiltMin','yearBuiltMax','daysOld','maxPricePerUnit'];
