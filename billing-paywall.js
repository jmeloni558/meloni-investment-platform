'use strict';
(()=>{
  if((window.__propertyThesisBillingV||0)>=6)return;window.__propertyThesisBillingV=6;
  ...
  window.PropertyThesisBilling={checkout,upgrade,claim,ensureAccessForCurrent};if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start,{once:true});else start();
})();
