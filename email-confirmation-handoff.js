...
(()=>{
  ...
  function show(state){
    ...
    if(!overlay){
      ...
      document.getElementById('ptHandoffContinue').onclick=()=>{window.__ptConfirmationHandoff=false;overlay.remove();window.AppNavigationToolbar?.resumeFreeAnalysis?.();};
    }
    if(state==='complete'){
